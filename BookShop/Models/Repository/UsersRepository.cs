...
namespace BookShop.Models.Repository
{
    public class UsersRepository:IUsersRepository
    {
        ...
        public async Task<IdentityResult> RegisterAsync(RegisterBaseViewModel ViewModel)
        {
            ...
            var user = new ApplicationUser { UserName = ViewModel.UserName, Email = ViewModel.Email, PhoneNumber = ViewModel.PhoneNumber, RegisterDate = DateTime.Now, IsActive = true, BirthDate = BirthDateMildai, EmailConfirmed = ViewModel.EmailConfirmed, PhoneNumberConfirmed = ViewModel.PhoneNumberConfirmed };
        ...
        {
            var role = _roleManager.FindByIdAsync(name);
            if (role != null)
