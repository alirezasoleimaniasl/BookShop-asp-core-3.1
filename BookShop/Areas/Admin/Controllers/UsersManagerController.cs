...
namespace BookShop.Areas.Admin.Controllers
{
    ...
    public class UsersManagerController : Controller
    {
        ...
        public async Task<IActionResult> Index(string Msg, int page=1, int row=5, string sortExpression = "FirstName", string firstName = "")
        {
            if(Msg=="Success")
            {
            ...
            var PagingModel = PagingList.Create(await _userManager.GetAllUsersWithRolesAsync(), row, page,sortExpression,"FirstName");
        ...
        [HttpGet]
        [Authorize(Policy = ConstantPolicies.DynamicPermission)]
        [DisplayName("مشاهده جزئیات کاربران")]
        ...
        [HttpGet]
        [Authorize(Policy = ConstantPolicies.DynamicPermission)]
        [DisplayName("تعویض رمز عبور کاربران")]
